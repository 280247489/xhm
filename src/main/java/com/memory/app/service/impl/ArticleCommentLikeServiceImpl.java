...
public class ArticleCommentLikeServiceImpl implements ArticleCommentLikeService {
    ...
    @Autowired
    public ArticleCommentLikeRepository repository;
   ...
   public ArticleCommentLike add(ArticleCommentLike articleCommentLike){
     ...
     */
    @Override
    public int getArticleCommentLikeCount(String userId,String commentId){

        return repository.countByCommentIdAndUserId(commentId,userId);
    }
